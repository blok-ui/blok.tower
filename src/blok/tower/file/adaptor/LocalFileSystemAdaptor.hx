package blok.tower.file.adaptor;
...
// @todo: When (if?) asys is ever ready, convert this Adaptor to use it.
class LocalFileSystemAdaptor implements FileSystemAdaptor {
  final root:String;
